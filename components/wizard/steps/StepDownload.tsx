...
export function StepDownload({ files, locale, onRestart }: StepDownloadProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <svg className="w-5 h-5 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="var(--success-text)">
      ...
      <div className="space-y-3">
        {files.map((file) => (
          ...
          >
            ...
            >
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="var(--amber-400)">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <button
                ...
                style={{ backgroundColor: 'var(--amber-400)', color: 'var(--cta-text)' }}
              >
      ...
      <div className="flex items-center justify-between pt-2">
        ...
        <button
          ...
          style={{ backgroundColor: 'var(--amber-400)', color: 'var(--cta-text)', border: 'none', cursor: 'pointer' }}
        >
