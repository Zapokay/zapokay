          ...
          <button
            ...
            className={`
              ...
              ${data.language === lang
                ...
                : 'border-ivory-dark bg-white text-navy-700 hover:border-navy-400 hover:shadow-md'
              }
            `}
          >
            <span className="text-3xl">{lang === 'fr' ? '🇨🇦' : '🇨🇦'}</span>
            <span className="font-sora font-semibold text-lg">
              {lang === 'fr' ? 'Français' : 'English'}
            </span>
            {data.language === lang && (
              <div className="absolute top-3 right-3">
                <div className="w-5 h-5 bg-[#D4821A] rounded-full flex items-center justify-center">
