    ...
    <div>
      ...
      {fiscalYearsConfigured && !hasFiscalYearConfig && (
        <div style={{
          ...
          <a
            href={`/${locale}/dashboard/settings`}
            style={{ fontSize: '13px', fontWeight: 600, color: '#7A5804', textDecoration: 'underline' }}
          >
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span style={{ fontSize: '13px', color: '#2E5425' }}>{fr ? 'Complétés' : 'Completed'}</span>
              </div>
              <span style={{ fontSize: '13px', fontWeight: 600, color: '#2E5425' }}>{compliantCount}/{total}</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span style={{ fontSize: '16px' }}>⏳</span>
                <span style={{ fontSize: '13px', color: '#7A5804' }}>{fr ? 'En attente' : 'Pending'}</span>
              </div>
              <span style={{ fontSize: '13px', fontWeight: 600, color: '#7A5804' }}>{pendingCount}/{total}</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span style={{ fontSize: '16px' }}>❌</span>
                <span style={{ fontSize: '13px', color: '#6B1E1E' }}>{fr ? 'À corriger' : 'To fix'}</span>
              </div>
              <span style={{ fontSize: '13px', fontWeight: 600, color: '#6B1E1E' }}>{urgentCount}/{total}</span>
            </div>
          </div>
        </div>
      )}
